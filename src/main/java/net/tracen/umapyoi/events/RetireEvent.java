...
public class RetireEvent extends Event {
    public static class Pre extends RetireEvent implements ICancellableEvent {
        ...
        public static ItemStack getDefaultOutputStack(ItemStack soul, List<UmaFactorStack> factors) {
            ...
            result.set(DataComponentsTypeRegistry.DATA_LOCATION, new DataLocation(UmaSoulUtils.getName(soul)));
            result.set(DataComponentsTypeRegistry.FACTOR_DATA, UmaFactorUtils.serializeData(factors));
            return result;
        }
