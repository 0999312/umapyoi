...
public class VillagerTradeHandler {
    ...
    public static void addTrainerTrade(VillagerTradesEvent event) {
        addVillageTrade(event, new ResourceLocation(Umapyoi.MODID, "trainer"), 1,
        ...
        addVillageTrade(event, new ResourceLocation(Umapyoi.MODID, "trainer"), 2,
        ...
        addVillageTrade(event, new ResourceLocation(Umapyoi.MODID, "trainer"), 2, new SkillBooksItemListing(10));

        addVillageTrade(event, new ResourceLocation(Umapyoi.MODID, "trainer"), 3,
        ...
        addVillageTrade(event, new ResourceLocation(Umapyoi.MODID, "trainer"), 3, new SkillBooksItemListing(20));

        addVillageTrade(event, new ResourceLocation(Umapyoi.MODID, "trainer"), 4,
        ...
        addVillageTrade(event, new ResourceLocation(Umapyoi.MODID, "trainer"), 4, new SkillBooksItemListing(30));

        addVillageTrade(event, new ResourceLocation(Umapyoi.MODID, "trainer"), 5,
        ...
        addVillageTrade(event, new ResourceLocation(Umapyoi.MODID, "trainer"), 5, new SkillBooksItemListing(30));
    ...
    public static void addVillageTrade(VillagerTradesEvent event, ResourceLocation villager, int level,
            VillagerTrades.ItemListing listing) {
        Int2ObjectMap<List<VillagerTrades.ItemListing>> trades = event.getTrades();
        VillagerProfession profession = event.getType();
        if (profession.getRegistryName() == null)
            return;
        if (profession.getRegistryName().equals(villager)) {
