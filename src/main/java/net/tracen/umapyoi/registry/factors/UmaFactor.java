...
public class UmaFactor{
    public static class UmaFactorComparator implements Comparator<DeferredHolder<UmaFactor, ? extends UmaFactor>> {
        public static UmaFactorComparator INSTANCE = new UmaFactorComparator();
        @Override
        public int compare(DeferredHolder<UmaFactor, ? extends UmaFactor> o1, DeferredHolder<UmaFactor, ? extends UmaFactor> o2) {
