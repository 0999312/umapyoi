...
public class ItemRegistry {
    ...
    public static final DeferredItem<Item> SILVER_UMA_PEDESTAL = register("silver_uma_pedestal",
            () -> new BlockItem(BlockRegistry.SILVER_UMA_PEDESTAL.get(), Umapyoi.defaultItemProperties()));
    
    public static final DeferredItem<Item> UMA_PEDESTAL = register("uma_pedestal",
            () -> new BlockItem(BlockRegistry.UMA_PEDESTAL.get(), Umapyoi.defaultItemProperties()));

    public static final DeferredItem<Item> UMA_STATUE = register("uma_statue",
            () -> new BlockItem(BlockRegistry.UMA_STATUES.get(), Umapyoi.defaultItemProperties()));
    
    public static final DeferredItem<Item> THREE_GODDESS = register("three_goddess",
            () -> new BlockItem(BlockRegistry.THREE_GODDESS.get(), Umapyoi.defaultItemProperties()));

    public static final DeferredItem<Item> TRAINING_FACILITY = register("training_facility",
            () -> new BlockItem(BlockRegistry.TRAINING_FACILITY.get(), Umapyoi.defaultItemProperties()));

    public static final DeferredItem<Item> SKILL_LEARNING_TABLE = register("skill_learning_table",
            () -> new BlockItem(BlockRegistry.SKILL_LEARNING_TABLE.get(), Umapyoi.defaultItemProperties()));

    public static final DeferredItem<Item> REGISTER_LECTERN = register("register_lectern",
            () -> new BlockItem(BlockRegistry.REGISTER_LECTERN.get(), Umapyoi.defaultItemProperties()));
    
    public static final DeferredItem<Item> DISASSEMBLY_BLOCK = register("disassembly_block",
    ...
    public static final DeferredItem<Item> SUMMER_UNIFORM = register("summer_uniform", UmaSuitItem::new);
...
//    public static final DeferredItem<Item> KINDERGARTEN_UNIFORM = register("kindergarten_uniform", UmaSuitItem::new);
    ...
    public static final DeferredItem<Item> BLANK_TICKET = register("blank_ticket", ItemRegistry::newMaterial);
    public static final DeferredItem<Item> UMA_TICKET = register("uma_ticket", UmaTicketItem::new);
    public static final DeferredItem<Item> SR_UMA_TICKET = register("sr_uma_ticket", UmaTicketItem::new);
    public static final DeferredItem<Item> SSR_UMA_TICKET = register("ssr_uma_ticket", UmaTicketItem::new);
    public static final DeferredItem<Item> CARD_TICKET = register("card_ticket", UmaTicketItem::new);
    public static final DeferredItem<Item> SR_CARD_TICKET = register("sr_card_ticket", UmaTicketItem::new);
    public static final DeferredItem<Item> SSR_CARD_TICKET = register("ssr_card_ticket", UmaTicketItem::new);
    
    public static final DeferredItem<Item> CRYSTAL_SILVER = register("crystal_silver", ItemRegistry::newMaterial);
    public static final DeferredItem<Item> CRYSTAL_GOLD = register("crystal_gold", ItemRegistry::newMaterial);
    public static final DeferredItem<Item> CRYSTAL_RAINBOW = register("crystal_rainbow", ItemRegistry::newMaterial);
    public static final DeferredItem<Item> HORSESHOE_SILVER = register("horseshoe_silver", ItemRegistry::newMaterial);
    public static final DeferredItem<Item> HORSESHOE_GOLD = register("horseshoe_gold", ItemRegistry::newMaterial);
    public static final DeferredItem<Item> HORSESHOE_RAINBOW = register("horseshoe_rainbow", ItemRegistry::newMaterial);

    public static final DeferredItem<Item> SPEED_LOW_ITEM = register("speed_low_item", () -> {
        return new TrainingItem(SupportType.SPEED, TrainingSupportRegistry.SPEED_SUPPORT, 1);
    });
    public static final DeferredItem<Item> SPEED_MID_ITEM = register("speed_mid_item", () -> {
        return new TrainingItem(SupportType.SPEED, TrainingSupportRegistry.SPEED_SUPPORT, 2);
    });
    public static final DeferredItem<Item> SPEED_HIGH_ITEM = register("speed_high_item", () -> {
        return new TrainingItem(SupportType.SPEED, TrainingSupportRegistry.SPEED_SUPPORT, 3);
    });

    public static final DeferredItem<Item> STAMINA_LOW_ITEM = register("stamina_low_item", () -> {
        return new TrainingItem(SupportType.STAMINA, TrainingSupportRegistry.STAMINA_SUPPORT, 1);
    });
    public static final DeferredItem<Item> STAMINA_MID_ITEM = register("stamina_mid_item", () -> {
        return new TrainingItem(SupportType.STAMINA, TrainingSupportRegistry.STAMINA_SUPPORT, 2);
    });
    public static final DeferredItem<Item> STAMINA_HIGH_ITEM = register("stamina_high_item", () -> {
        return new TrainingItem(SupportType.STAMINA, TrainingSupportRegistry.STAMINA_SUPPORT, 3);
    });

    public static final DeferredItem<Item> STRENGTH_LOW_ITEM = register("strength_low_item", () -> {
        return new TrainingItem(SupportType.STRENGTH, TrainingSupportRegistry.STRENGTH_SUPPORT, 1);
    });
    public static final DeferredItem<Item> STRENGTH_MID_ITEM = register("strength_mid_item", () -> {
        return new TrainingItem(SupportType.STRENGTH, TrainingSupportRegistry.STRENGTH_SUPPORT, 2);
    });
    public static final DeferredItem<Item> STRENGTH_HIGH_ITEM = register("strength_high_item", () -> {
        return new TrainingItem(SupportType.STRENGTH, TrainingSupportRegistry.STRENGTH_SUPPORT, 3);
    });

    public static final DeferredItem<Item> MENTALITY_LOW_ITEM = register("mentality_low_item", () -> {
        return new TrainingItem(SupportType.GUTS, TrainingSupportRegistry.GUTS_SUPPORT, 1);
    });
    public static final DeferredItem<Item> MENTALITY_MID_ITEM = register("mentality_mid_item", () -> {
        return new TrainingItem(SupportType.GUTS, TrainingSupportRegistry.GUTS_SUPPORT, 2);
    });
    public static final DeferredItem<Item> MENTALITY_HIGH_ITEM = register("mentality_high_item", () -> {
        return new TrainingItem(SupportType.GUTS, TrainingSupportRegistry.GUTS_SUPPORT, 3);
    });

    public static final DeferredItem<Item> WISDOM_LOW_ITEM = register("wisdom_low_item", () -> {
        return new TrainingItem(SupportType.WISDOM, TrainingSupportRegistry.WISDOM_SUPPORT, 1);
    });
    public static final DeferredItem<Item> WISDOM_MID_ITEM = register("wisdom_mid_item", () -> {
        return new TrainingItem(SupportType.WISDOM, TrainingSupportRegistry.WISDOM_SUPPORT, 2);
    });
    public static final DeferredItem<Item> WISDOM_HIGH_ITEM = register("wisdom_high_item", () -> {
    ...
    public static final DeferredItem<Item> MEDIUM_ENERGY_DRINK = register("medium_energy_drink",
    ...
    public static final DeferredItem<Item> LARGE_ENERGY_DRINK = register("large_energy_drink",
