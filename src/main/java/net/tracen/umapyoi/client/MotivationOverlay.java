...
public class MotivationOverlay implements LayeredDraw.Layer
{
    ...
    public static final ResourceLocation HUD = ResourceLocation.fromNamespaceAndPath(Umapyoi.MODID, "textures/gui/motivations.png");
