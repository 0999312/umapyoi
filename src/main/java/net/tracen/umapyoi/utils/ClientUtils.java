...
public class ClientUtils {
    ...
    public static void renderModelInInventory(int pPosX, int pPosY, int pScale, Model pModel, ResourceLocation texture) {
        renderModelInInventory(pPosX, pPosY, pScale, null, pModel, texture);
    }
    
    public static void renderModelInInventory(int pPosX, int pPosY, int pScale, Quaternion pQuaternion, Model pModel, ResourceLocation texture) {
